        ...
        <div class="main_page">
            ...
            <div class="main_course">
                <div class="alert alert-dismissible fade show" id="alert" role="alert">
                    ...
                    <div id="alert_desc">
                        <p>Here’s where you add notes content—like chapter notes, assignment sheets, and more. Click
    ...
    <script>
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success : function(data){
                        if(data == true){
                            ...
                            $('#upload').not(this).attr('disabled', true)
                            $(window).scrollTop(0);
                        }else{
                            console.log(data)
            ...
            $(document).on("click", "#submit_form", function(e){
                e.preventDefault();
                window.location = "http://localhost/project/instructor/create/pricing.php"
            })
        });
    </script> 
</body>
