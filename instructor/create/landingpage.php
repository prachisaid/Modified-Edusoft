                    ...
                    <div class="form_objective">
                        <form name="Form1" id="submit_landing_page">
                            <div id="elem">
                                ...
                                <input type="text" name="course_title" id="obj1" class="info" placeholder="Insert your course title">

                                <label for="course_subtitle">Course subtitle</label>
                                <input type="text" name="course_subtitle" id="obj2" class="info" placeholder="Insert your course subtitle">

                                <label for="course_description">Course description</label>
                                <input type="text" name="course_description" id="course_description" class="info" placeholder="Insert your course description">
                                ...
                                <div class="images_for_page" style="margin-top: 23px ;">
                                    ...
                                    <div id="course_image">
                                        ...
                                        <div id="content">
                                            <p>Upload your course image here. It must meet our <span style="color: blueviolet;"> course image quality standards </span>
                                                to be accepted. Important guidelines: 750x422 pixels; .jpg, .jpeg,. gif,
                                                or .png. no text on the image.</p>
                                            <input accept=".gif,.jpg,.jpeg,.png" type="file" name="image" id="FileUploaderS3-0--29" class="sr-only">
                                        </div>
                                    </div>
                                    ...
                                    <div id="course_image">
                                        ...
                                        <div id="content">
                                            <p>Students who watch a well-made promo video are <span style="font-weight:bolder;"> 5X more likely to enroll </span>in your
                                                ...
                                                videos. <span style="color: blueviolet;">Learn how to make yours
                                                    awesome!</span></p>
                                            <input accept=".avi,.mpg,.mpeg,.flv,.mov,.m2v,.m4v,.mp4,.rm,.ram,.vob,.ogv,.webm,.wmv" type="file" name="video" id="FileUploaderS3-0--30" class="sr-only">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            // $("#msg").html(data);
                            window.location = "http://localhost/project/instructor/create/notes.php"
                        }
                    })
            })
        })
