                    ...
                    <div class="form_objective">
                        <form action="">
                            <div id="elem" class="elem">
                                ...
                                <input type="text" name="obj1" id="obj1" class="obj" placeholder="Example: Define the roles and responsibilities of a project manager">
                                <input type="text" name="obj2" id="obj2" class="obj" placeholder="Example: Estimate project timelines and budgets">
                                <input type="text" name="obj3" id="obj3" class="obj" placeholder="Example: Identify and manage project risks">
                                <input type="text" name="obj4" id="obj4" class="obj" placeholder="Example: Complete a case study to manage a project from conception to completion">
                                <input type="text" name="obj5" id="obj5" class="obj" placeholder="Example: Complete a case study to manage a project from conception to completion">
                        ...
                        <form action="">
                            <div id="elem" class="elem">
                                ...
                                <div>List the required skills, experience, tools or equipment learners should have prior to
                                    ...
                                    beginners.</div>
                                <input type="text" name="req1" id="req1" class="obj" placeholder="Example: No programming experience needed you will learn everything you need to know">
                                <input type="text" name="req2" id="req2" class="obj" placeholder="Example: No programming experience needed you will learn everything you need to know">
                    ...
                    <div class="form_objective">
                        <form action="">
                            <div id="elem" class="elem">
                                ...
                                <input type="text" name="intd1" id="intd1" class="obj is-invalid" placeholder="Example: No programming experience needed you will learn everything you need to know">
                                <input type="text" name="intd2" id="intd2" class="obj" placeholder="Example: No programming experience needed you will learn everything you need to know">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", "#submit_form", function() {
                ...
                if (obj1 == '' && obj2 == '' && obj3 == '' && obj4 == '' && obj5 == '' && req1 == '' && req2 == '' && intd1 == '' && intd2 == '') {
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            // $('#msg').html(data)
                            window.location = "http://localhost/project/instructor/create/curriculum.php"
                        }
                    })
                }
            })
